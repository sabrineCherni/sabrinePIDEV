...
public class LoginBean implements Serializable { 
	...
	public String doLogin() { 
		...
		{ navigateTo = "/pages/admin/admintimesheet?faces-redirect=true"; 
		loggedIn = true; 
		LoginBean.setEmployeSta(employe);
		}
		if (employe != null && employe.getRole() == Role.TECHNICIEN) 
		{ navigateTo = "/pages/admin/schedule?faces-redirect=true"; 
		loggedIn = true; 
		LoginBean.setEmployeSta(employe);
		}
